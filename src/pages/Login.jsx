    ...
    return (
        <div style={{
            ...
            <div className="glass-panel" style={{
                width: '100%',
                maxWidth: '420px',
                padding: width < 480 ? '32px 24px' : '48px',
                ...
                <div style={{ textAlign: 'center', display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
                    <div style={{ marginBottom: '20px' }}>
                        <Logo size={width < 480 ? 48 : 64} showText={false} />
                    </div>
                    <h1 style={{ fontSize: width < 480 ? '1.5rem' : '2rem', marginBottom: '8px' }}>Nebula Pro</h1>
                    <p style={{ color: 'var(--text-secondary)', fontSize: '0.9rem' }}>Sign in to continue to dashboard</p>
                </div>
