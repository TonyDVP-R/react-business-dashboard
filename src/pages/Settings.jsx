...
const Settings = () => {
    ...
    return (
        <div className="animate-fade-in" style={{ maxWidth: '800px', paddingBottom: '40px' }}>
            <h1 style={{ fontSize: '1.75rem', fontWeight: 700, marginBottom: '8px' }}>Account Settings</h1>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '32px' }}>
                ...
                <Card title="Public Profile">
                    <div className="flex-responsive" style={{ padding: '10px 0' }}>
                        {/* Avatar Section */}
                        <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '16px', flexShrink: 0 }}>
                            ...
                            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', gap: '8px' }}>
                                <p style={{ fontSize: '0.75rem', color: 'var(--text-tertiary)', margin: 0, textAlign: 'center' }}>JPG, PNG or GIF. Max 1MB.</p>
                                {formData.avatar && (
                                    <button
                                        type="button"
                ...
                <Card title="Danger Zone">
                    <div style={{
                        ...
                        <div>
                            <h4 style={{ margin: 0, marginBottom: '4px', color: 'var(--danger)' }}>Delete Account</h4>
                            <p style={{ fontSize: '0.85rem', color: 'var(--text-tertiary)', margin: 0 }}>Once you delete your account, there is no going back. Please be certain.</p>
                        </div>
                        <Button
                            variant="danger"
                            style={{ width: width < 480 ? '100%' : 'auto' }}
                            onClick={() => {
